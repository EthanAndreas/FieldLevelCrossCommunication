...
#if DEBUG
  #define SEGGER_RTT_MODE_DEFAULT                 SEGGER_RTT_MODE_BLOCK_IF_FIFO_FULL // Mode for pre-initialized terminal channel (buffer 0) (default in debug builds: SEGGER_RTT_MODE_BLOCK_IF_FIFO_FULL)
#else
  #define SEGGER_RTT_MODE_DEFAULT                 SEGGER_RTT_MODE_NO_BLOCK_SKIP      // Mode for pre-initialized terminal channel (buffer 0) (default in non-debug builds: SEGGER_RTT_MODE_NO_BLOCK_SKIP)
#endif
#endif
