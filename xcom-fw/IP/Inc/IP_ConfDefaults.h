...
//
  ...
  #define IP_TIMERS_MAX_PERIOD_SYNC       1000    // Maximum period [ms] that will be synced to each other.
#endif
  ...
  #if (IP_MAX_IFACES == 0)
    #define IP_ALLOW_NOLOCK               1
  #else
    #define IP_ALLOW_NOLOCK               0
  #endif
#endif
  ...
  #define IP_TX_FIFO_TIMEOUT              100     // For the moment this is not the definitive timeout but more like a placeholder to define a timeout
